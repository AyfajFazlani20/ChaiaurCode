...
import getLogsByProject from '@salesforce/apex/LogFetcherThird.getLogsByProject';
import getTotalLogsCount from '@salesforce/apex/LogFetcherThird.getTotalLogsCount';
import { loadScript } from 'lightning/platformResourceLoader';
import XLSX_RESOURCE from '@salesforce/resourceUrl/xlsx';
import getAllFilteredLogs from '@salesforce/apex/LogFetcherThird.getAllFilteredLogs';
import checkMember from '@salesforce/apex/LogController.checkMember';
import USER_ID from '@salesforce/user/Id';

import getLogsByProjectwithoutpagination from '@salesforce/apex/LogFetcherThird.getLogsByProjectwithoutpagination';
...
@track sortDirection = 'desc';  // Default sort direction
    ...
    loadTotalMinutes() {
        ...
        .then(result => {
            console.log('hi hi inside inner func');
            ...
            this.totalMinutes = this.logs1.reduce((sum, log1) => {
                return sum + (log1.Mins__c ? parseInt(log1.Mins__c, 10) : 0);
            }, 0);
